...
npm run verify:all        # 以上三者 + verify:sandbox + verify:visual，共 102 条（14 + 29 + 37 + 20 + 2）
```
...
npm run verify:visual     # 渲染层回归，29 条判据（A1–A22，含版面/位面/道具栏/手绘怪物、
...
npm run verify:all        # 以上五套，共 102 条判据（14 + 29 + 37 + 20 + 2）
```
